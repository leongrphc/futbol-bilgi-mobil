...
export default function Lobby() {
  ...
  useFocusEffect(useCallback(() => {
    let alive = true;
    void (async () => {
      const ranked = await supabase.rpc("ranked_progress");
