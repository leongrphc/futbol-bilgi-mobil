...
export type ChatStyleId = "chat-classic" | "chat-floodlight" | "chat-derby" | "chat-neon" | "chat-aurora" | "chat-champion";
...
export const chatStyleItems = [
  ...
  { item_id: "chat-aurora", name: "Aurora Yankısı", kind: "CHAT_STYLE", accent: "#66E4FF" },
  { item_id: "chat-champion", name: "Şampiyon Sesi", kind: "CHAT_STYLE", accent: "#FFD76A" },
] as const;
