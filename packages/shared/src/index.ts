...
export const PREMIUM_EMOTE_IDS: readonly EmoteId[] = ["emote-goat", "emote-crown", "emote-bolt", "emote-trophy", "emote-skull", "emote-party", "emote-cold", "emote-heart"] as const;
